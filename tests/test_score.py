...
class Test_Score(unittest.TestCase):
    ...
    def test_ScoreFactory(self):
        ...
        self.assertEqual(s.GameFormat,'Szybka piłka')
    ...
    def test_SetUpScore(self):
        ...
        s.setDatetime('2009-10-08 11:00').setTournament('t')
        s.setTournamentRank('30').setGameFormat('GF')
        ...
        self.assertEqual(s.GameFormat,'GF')
